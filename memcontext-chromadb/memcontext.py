...
class Memcontext:
    ...
    def close(self):
        ...
        print("Memcontext: Process is terminating. Saving all metadata to disk...")
        self.storage_provider.save_all_metadata()
        print("Memcontext: Metadata saved successfully.")
        ...
        if current_heat >= self.mid_term_heat_threshold:
            ...
            if unanalyzed_pages:
                ...
                if updated_profile:
                    ...
                    print(f"Memcontext: User profile update recorded in memory for user {self.user_id}.")
    ...
    def add_memory(self, user_input: str, agent_response: str, timestamp = None, meta_data = None):
        ...
        print(f"Memcontext: Added QA to short-term. User: {user_input[:30]}...")

        if self.short_term_memory.is_full():
            print("Memcontext: Short-term memory full. Processing to mid-term.")
    ...
    def get_response(self, query: str, relationship_with_user="friend", style_hint="", user_conversation_meta_data = None) -> str:
        ...
        """
        print(f"Memcontext: Generating response for query: '{query[:50]}...'")
        ...
        print("Memcontext: Calling LLM for final response generation...")
        # print("System Prompt:\n", system_prompt_text)
        # print("User Prompt:\n", user_prompt_text)
    ...
    def force_mid_term_analysis(self):
        ...
        print("Memcontext: Force-triggering mid-term analysis...")
        self._trigger_profile_and_knowledge_update_if_needed()
